...
strings <- c(
  ...
  dataset.name.short = "JMMI UKR Customers Hromada",   # provide a short name for filenames of output documents (e.g. "POL_PDM")
  ...
  filename.daf.tabular = "resources/Customers/DAF_hromada.xlsx"     # filename of your DAF
)
...
rmarkdown::render('analysis_tabular_hromada.Rmd',
                  output_file = paste0("output/Customers/", strings['dataset.name.short'], "_Tabular_Analysis_Hromada", strings['out_date'],".html"))

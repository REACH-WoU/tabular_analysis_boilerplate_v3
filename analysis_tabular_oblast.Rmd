...
JMMI_variable <- c("Customers")
  ...
  source("src/init.R")
  sampling <- read_excel("resources/Customers/sample.xlsx")
...
save.dfs(sorted_df, paste0("output/Customers/", strings['dataset.name.short'], "_combined_analysis_toc_", strings['out_date'], ".xlsx"))
...
combined_xlsx_filename <- paste0("output/Customers/", strings['dataset.name.short'], "_combined_analysis_by_tab_", strings['out_date'], ".xlsx")
